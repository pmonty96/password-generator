...
document.getElementById("generate").addEventListener("click",  function main() {
  passwordLength = parseInt(prompt("How many characters long? Must be between 8 and 128"))
    while ((passwordLength < 8) || (passwordLength > 128) || (passwordLength === "null") || (passwordLength === undefined) || (Number.isNaN(passwordLength) === true)){
